        ...
        <div className="grid gap-10 lg:grid-cols-12">
          ...
          <div className="border-t border-black/20 lg:col-span-7 lg:col-start-6">
            {locationsData.map((location) => (
              <Link key={location.name} id={`area-${location.name.toLowerCase()}`} to={`/service-areas/${location.name.toLowerCase()}`} className="group grid grid-cols-[1fr_auto] items-center gap-4 border-b border-black/20 py-6 transition hover:pl-2">
                <div>
