        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center">
          ...
          >
            ...
            <motion.div
              ...
              whileInView="show"
              viewport={viewportConfig}
              className="mt-10 border-t border-black/15"
            >
              {steps.map(([title, description]) => (
                <motion.div key={title} variants={fadeUp} className="grid grid-cols-[24px_1fr] gap-4 border-b border-black/15 py-6">
            ...
            <a href="#reservation" className="mt-8 inline-flex items-center gap-3 bg-[#131514] px-6 py-4 text-[12px] font-semibold text-white transition hover:bg-gold shadow-md">Check availability for my date <ArrowUpRight className="h-4 w-4" /></a>
          </motion.div>
          ...
          <motion.div
            ...
            whileInView="show"
            viewport={viewportConfig}
            className="relative lg:col-span-7 lg:pl-8"
          >
            <div className="relative aspect-[4/5] overflow-hidden sm:aspect-[5/4] lg:aspect-[4/5] rounded-sm shadow-xl">
