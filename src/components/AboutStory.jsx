      ...
      <div className="mx-auto grid max-w-[1320px] gap-12 px-5 lg:grid-cols-12 lg:px-8">
        ...
        <div className="lg:col-span-7 lg:col-start-6">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <a href={`tel:${companyInfo.phoneRaw}`} className="inline-flex items-center gap-3 bg-[#131514] px-6 py-4 text-[12px] font-semibold text-white transition hover:bg-gold"><Phone className="h-4 w-4" />Call João directly</a>
            <a href="#reservation" className="inline-flex items-center gap-2 px-2 text-[12px] font-semibold text-gold">Check my date <ArrowUpRight className="h-4 w-4" /></a>
          </div>
        </div>
      </div>
    </section>
