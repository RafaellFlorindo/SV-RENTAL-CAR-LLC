    ...
    <footer className="bg-[#131514] text-white">
      ...
      <div className="mx-auto max-w-[1440px] px-5 py-16 lg:px-8">
        ...
        <div className="flex flex-col gap-5 pt-8 text-[9px] uppercase tracking-[0.12em] text-white/35 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-6"><a href="#">Privacy</a><a href="#">Terms</a><a href="#top" aria-label="Back to top" className="flex h-9 w-9 items-center justify-center rounded-full border border-white/20 text-white"><ArrowUp className="h-4 w-4" /></a></div>
        </div>
      </div>
      <GhlChatWidget />
    </footer>
